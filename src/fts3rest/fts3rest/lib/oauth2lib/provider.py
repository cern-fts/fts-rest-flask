...
class AuthorizationProvider(Provider):
    ...
    def refresh_token(
        self, grant_type, client_id, client_secret, refresh_token, **params
    ):
    ...
    def get_token(
        self, grant_type, client_id, client_secret, redirect_uri, code, **params
    ):
    ...
    def validate_client_secret(self, client_id, client_secret):
        raise NotImplementedError(
            "Subclasses must implement " "validate_client_secret."
        )
    ...
    def from_authorization_code(self, client_id, code, scope):
        raise NotImplementedError(
            "Subclasses must implement " "from_authorization_code."
        )
    ...
    def persist_authorization_code(self, client_id, code, scope):
        raise NotImplementedError(
            "Subclasses must implement " "persist_authorization_code."
        )
    ...
    def persist_token_information(
        ...
        raise NotImplementedError(
            "Subclasses must implement " "persist_token_information."
        )

    def discard_authorization_code(self, client_id, code):
        raise NotImplementedError(
            "Subclasses must implement " "discard_authorization_code."
        )
...
class ResourceProvider(Provider):
    ...
    def get_authorization_header(self):
        raise NotImplementedError(
            "Subclasses must implement " "get_authorization_header."
        )
