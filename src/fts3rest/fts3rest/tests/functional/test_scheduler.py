            ...
            "files": [
                {
                    ...
                    "destinations": [
                        "http://dest.ch/file" + str(random.randint(20000, 100000))
                    ],
            ...
            "files": [
                {
                    ...
                    "destinations": [
                        "http://dest.ch/file" + str(random.randint(100, 200))
                    ],
            ...
            "files": [
                {
                    ...
                    "destinations": [
                        "http://dest.ch/file" + str(random.randint(0, 100))
                    ],
                    "selection_strategy": "orderly",
                    "checksum": "adler32:1234",
                    "filesize": 1024,
