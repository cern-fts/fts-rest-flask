...
class TestJobSubmission(TestController):
    ...
    def test_files_balanced(self):
            ...
            files.append(
                {
                    ...
                    "destinations": [
                        "root://dest.ch/file%d%d" % (r, random.randint(0, 100))
                    ],
                }
            )
        ...
        histogram, min_value, binsize, outsiders = scipy.stats.histogram(
            hashed_ids, defaultlimits=(0, 2 ** 16 - 1)
        )
