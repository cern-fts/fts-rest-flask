...
class TestBanning(TestController):
    ...
    def test_ban_dn(self):
        ...
        self.app.delete(
            url="/ban/dn?user_dn=%s" % quote("/DC=cern/CN=someone"), status=204
        )
        banned = Session.query(BannedDN).get("/DC=cern/CN=someone")
    ...
    def test_list_banned_dns(self):
        ...
        """
        canceled = self.app.post(
            url="/ban/dn", params={"user_dn": "/DC=cern/CN=someone"}, status=200
        ).json
        self.assertEqual(0, len(canceled))
    ...
    def test_ban_dn_submission(self):
        ...
        self.app.post(
            url="/jobs", content_type="application/json", params="[]", status=403
        )
    ...
    def test_ban_se(self):
        ...
        self.assertEqual(0, len(canceled))
        banned = (
            Session.query(BannedSE).filter(BannedSE.se == "gsiftp://nowhere").first()
        )
        self.assertNotEqual(None, banned)
        self.assertEqual(self.get_user_credentials().user_dn, banned.admin_dn)
        ...
        self.app.delete(
            url="/ban/se?storage=%s" % quote("gsiftp://nowhere"), status=204
        )
        banned = (
            Session.query(BannedSE).filter(BannedSE.se == "gsiftp://nowhere").first()
        )
    ...
    def test_list_banned_ses(self):
        ...
        """
        canceled = self.app.post(
            url="/ban/se", params={"storage": "gsiftp://nowhere"}, status=200
        ).json
        self.assertEqual(0, len(canceled))
    ...
    def test_ban_se_vo(self):
        ...
        self.app.delete(
            url="/ban/se?storage=%s&vo_name=testvo" % quote("gsiftp://nowhere"),
            status=204,
        )
    ...
    def test_ban_se_cancel(self):
        ...
        jobs = list()
        jobs.append(
            insert_job("testvo", "gsiftp://source", "gsiftp://destination", "SUBMITTED")
        )
        jobs.append(
            insert_job("testvo", "gsiftp://source", "gsiftp://destination2", "ACTIVE")
        )
        jobs.append(
            insert_job(
                "testvo",
        ...
        canceled_ids = self.app.post(
            url="/ban/se", params={"storage": "gsiftp://source"}, status=200
        ).json
    ...
    def test_ban_se_partial_job(self):
        ...
        job_id = insert_job(
            ...
            multiple=[
                ...
                ("gsiftp://other", "gsiftp://destination"),
            ],
        )
        canceled_ids = self.app.post(
            url="/ban/se", params={"storage": "gsiftp://source"}, status=200
    ...
    def test_ban_se_cancel_vo(self):
        ...
        jobs.append(
            insert_job("atlas", "gsiftp://source", "gsiftp://destination", "SUBMITTED")
        )
        jobs.append(
            insert_job("atlas", "gsiftp://source", "gsiftp://destination2", "SUBMITTED")
        )

        canceled_ids = self.app.post(
            url="/ban/se",
            params={
                "storage": "gsiftp://source",
                "status": "cancel",
                "vo_name": "testvo",
            },
            status=200,
    ...
    def test_unban_wait(self):
        ...
        self.app.delete(url="/ban/se?storage=%s" % quote("gsiftp://source"), status=204)
    ...
    def test_ban_se_bad_status(self):
        ...
        self.app.post(
            url="/ban/se",
            params={"storage": "gsiftp://source", "status": "blahblah"},
            status=400,
        )
    ...
    def test_ban_se_staging(self):
        ...
        self.app.post(
            url="/ban/se",
            params={"storage": "srm://source", "status": "wait", "allow_submit": True},
            status=200,
        )
        ...
        self.app.delete(url="/ban/se?storage=%s" % quote("srm://source"), status=204)
