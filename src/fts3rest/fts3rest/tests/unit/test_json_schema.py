...
class TestJsonSchema(unittest.TestCase):
    ...
    def setUp(self):
        self.data = {
            "files": [
                {
                    "sources": [
                        "srm://srm.grid.sara.nl:8443/pnfs/grid.sara.nl/data/dteam/test.rand"
                    ],
                    "destinations": [
                        "gsiftp://lxbra1910.cern.ch/lxbra1910.cern.ch:/tmp/file.aalvarez.copy"
                    ],
    ...
    def test_bad_reuse(self):
        ...
        self.assertRaises(
            jsonschema.ValidationError, jsonschema.validate, self.data, self.schema
        )
