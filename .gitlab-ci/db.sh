...
mysql -u=root -p=asdf -h=mariadb ftsflask < .gitlab-ci/db.sql
mysql -u=root -p=asdf -h=mariadb ftsflask < fts-schema-5.0.0.sql
mysql -u=root -p=asdf -h=mariadb ftsflask < fts-diff-6.0.0.sql
