...
curl -O https://gitlab.cern.ch/fts/fts3/-/raw/FTS-1744/src/db/schema/mysql/fts-schema-8.0.0.sql

mysql --user=root --password=asdf --host=mariadb ftsflask < fts-schema-8.0.0.sql
