...
curl -s -O https://gitlab.cern.ch/fts/fts3/-/raw/v3.13.3/src/db/schema/mysql/fts-schema-9.1.0.sql
curl -s -O https://gitlab.cern.ch/fts/fts3/-/raw/develop/src/db/schema/mysql/fts-diff-10.0.0.sql
mysql --user=root --password=ftsflaskroot --host=mysqldb ftsflask < fts-schema-9.1.0.sql
mysql --user=root --password=ftsflaskroot --host=mysqldb ftsflask < fts-diff-10.0.0.sql
