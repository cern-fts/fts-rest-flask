...
curl -s -O https://gitlab.cern.ch/fts/fts3/-/raw/FTS-1928/src/db/schema/mysql/fts-diff-9.0.0.sql
...
mysql --user=root --password=ftsflaskroot --host=mysqldb ftsflask < fts-diff-9.0.0.sql
