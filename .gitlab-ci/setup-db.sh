...
mysql --user=root --password=ftsflaskroot --host=mariadb ftsflask < fts-schema-8.0.1.sql
mysql --user=root --password=ftsflaskroot --host=mariadb ftsflask < fts-diff-8.1.0.sql
