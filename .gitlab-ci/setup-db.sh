...
echo "CREATE USER 'fts3'@'%';" | mysql --user=root --password=ftsflaskroot --host=mysqldb
echo "GRANT ALL PRIVILEGES ON ftsflask.* TO 'fts3'@'%' IDENTIFIED BY 'ftsflaskpass';" | mysql --user=root --password=ftsflaskroot --host=mysqldb
