...
curl -s -O https://gitlab.cern.ch/fts/fts3/-/raw/develop/src/db/schema/mysql/fts-schema-9.0.0.sql
curl -s -O https://gitlab.cern.ch/fts/fts3/-/raw/FTS-2007_overwrite_disk/src/db/schema/mysql/fts-diff-9.1.0.sql
mysql --user=root --password=ftsflaskroot --host=mysqldb ftsflask < fts-schema-9.0.0.sql
mysql --user=root --password=ftsflaskroot --host=mysqldb ftsflask < fts-diff-9.1.0.sql
